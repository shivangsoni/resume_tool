...
import { mergeProfileSuggestions, saveDocument } from "../database.js";
...
app.http("resume", {
  ...
  handler: async (request, context) => {
    ...
    try {
      ...
      let extractionStatus = "succeeded"; let extraction; let profile;
      try {
      ...
      return { status: 201, jsonBody: { document, profile, suggestions: extraction?.profile || {}, extractionStatus } };
